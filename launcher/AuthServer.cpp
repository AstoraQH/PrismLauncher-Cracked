...
void AuthServer::newConnection()
{
    ...
    connect(tcpSocket, &QTcpSocket::readyRead, this, [tcpSocket]() {
        ...
        if (requestPath == "/") {
            responseBody =
                "{\"Status\":\"OK\",\"Runtime-Mode\":\"productionMode\",\"Application-Author\":\"Mojang Web "
                "Force\",\"Application-Description\":\"Mojang Public "
                "API.\",\"Specification-Version\":\"3.58.0\",\"Application-Name\":\"yggdrasil.accounts.restlet.server.public\","
                "\"Implementation-Version\":\"3.58.0_build194\",\"Application-Owner\":\"Mojang\"}";
    ...
    connect(tcpSocket, &QTcpSocket::disconnected, this, [tcpSocket]() { tcpSocket->close(); });
}